...
/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 8939: /***/ (
      ...
      var _auth = __nccwpck_require__(1699);
    ...
    /***/ 9526: /***/ (__unused_webpack_module, exports) => {
      "use strict";
      ...
      routes.teamMembersSecondaryEmailsResendVerificationEmails = function (
        arg
      ) {
        return this.request(
        ...
        _createClass(DropboxAuth, [
                  ...
                  .then(function (digestedHash) {
                    var base64String = btoa(
                      String.fromCharCode.apply(
                        null,
                        new Uint8Array(digestedHash)
                      )
                    );
                    codeChallenge = (0, _utils.createBrowserSafeString)(
                      base64String
                    ).substr(0, 128);
          ...
          },
          {
            ...
            value: function generatePKCECodes() {
              ...
              if ((0, _utils.isBrowserEnv)() || (0, _utils.isWorkerEnv)()) {
                ...
                codeVerifier = (0, _utils.createBrowserSafeString)(
                  base64String
                ).substr(0, 128);
              } else {
          ...
          },
          {
            ...
            value: function getAuthenticationUrl(redirectUri, state) {
              ...
              if (
                tokenAccessType &&
                !TokenAccessTypes.includes(tokenAccessType)
              ) {
                throw new Error(
              ...
              if (includeGrantedScopes !== "none") {
                authUrl += "&include_granted_scopes=".concat(
          ...
          },
          {
            ...
            value: function getAccessTokenFromCode(redirectUri, code) {
              ...
              var path = (0, _utils.OAuth2TokenUrl)(
                this.domain,
          ...
          },
          {
            ...
            value: function refreshAccessToken() {
              ...
              var refreshUrl = (0, _utils.OAuth2TokenUrl)(
                this.domain,
                this.domainDelimiter
              );
              var fetchOptions = {
              ...
              return this.fetch(refreshUrl, fetchOptions)
                ...
                .then(function (res) {
                  ...
                  _this3.setAccessTokenExpiresAt(
                    (0, _utils.getTokenExpiresAtDate)(res.result.expires_in)
                  );
                });
            },
          },
    ...
    /***/ 9478: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 6258: /***/ (
      ...
      var Dropbox = /*#__PURE__*/ (function () {
        function Dropbox(options) {
          ...
          this.domainDelimiter =
            options.domainDelimiter || this.auth.domainDelimiter;
          ...
          },
          {
            ...
            value: function setAuthHeaders(auth, fetchOptions) {
              ...
              if (auth.split(",").length > 1) {
                ...
                if (
                  authTypes.includes(_constants.USER_AUTH) &&
                  this.auth.getAccessToken()
                ) {
                  auth = _constants.USER_AUTH;
                } else if (
                  authTypes.includes(_constants.TEAM_AUTH) &&
                  this.auth.getAccessToken()
                ) {
    ...
    /***/ 178: /***/ (__unused_webpack_module, exports) => {
       ...
       */
      var DropboxResponseError = /*#__PURE__*/ (exports.DropboxResponseError =
        (function (_Error) {
    ...
    /***/ 4201: /***/ (
      ...
      var DropboxResponse = (exports.DropboxResponse = function DropboxResponse(
        status,
        headers,
        result
      ) {
      ...
      function throwAsError(res) {
        return res.text().then(function (data) {
          ...
          throw new _error.DropboxResponseError(
            res.status,
            res.headers,
            errorObject
          );
    ...
    /***/ 59: /***/ (__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      exports.OAuth2TokenUrl =
        exports.OAuth2AuthorizationUrl =
        exports.baseApiUrl =
          undefined;
      ...
      var baseApiUrl = (exports.baseApiUrl = function baseApiUrl(subdomain) {
        ...
        if (
          domain !== _constants.DEFAULT_API_DOMAIN &&
          _constants.TEST_DOMAIN_MAPPINGS[subdomain] !== undefined
        ) {
        ...
        return "https://"
          .concat(subdomain)
          .concat(domainDelimiter)
          .concat(domain, "/2/");
      });

      var OAuth2AuthorizationUrl = (exports.OAuth2AuthorizationUrl =
        function OAuth2AuthorizationUrl() {
          var domain =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : _constants.DEFAULT_DOMAIN;
        ...
        readAndAssertNoEof(
          ...
          function (err) {
            ...
            for (var i = bufferSize - eocdrWithoutCommentSize; i >= 0; i -= 1) {
              ...
              var zip64EocdlOffset =
                bufferReadStart + i - zip64EocdlBuffer.length;
              readAndAssertNoEof(
                reader,
                zip64EocdlBuffer,
                0,
                ...
                function (err) {
                  ...
                  readAndAssertNoEof(
                    ...
                    function (err) {
                      ...
                      centralDirectoryOffset = readUInt64LE(
                        zip64EocdrBuffer,
                        48
                      );
              ...
              function (err) {
                ...
                if (
                  ...
                  if (entry.uncompressedSize === 0xffffffff) {
                    ...
                    entry.uncompressedSize = readUInt64LE(
                      zip64EiefBuffer,
                      index
                    );
                    index += 8;
        ...
        if (callback == null) {
          ...
          if (options.decrypt != null) {
            ...
            if (options.decrypt !== false)
              throw new Error(
                "invalid options.decrypt value: " + options.decrypt
              );
          ...
          if (options.decompress != null) {
            ...
            if (
              !(options.decompress === false || options.decompress === true)
            ) {
              throw new Error(
          ...
          function (err) {
            try {
              ...
              if (entry.compressionMethod === 0) {
                ...
                decompress =
                  options.decompress != null ? options.decompress : true;
              } else {
                return callback(
                  new Error(
              ...
              if (decompress) {
                ...
                if (self.validateEntrySizes) {
                  endpointStream = new AssertByteCountStream(
                    entry.uncompressedSize
                  );
